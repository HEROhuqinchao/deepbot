...
export function BrowserToolConfig({ onClose }: BrowserToolConfigProps) {
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex items-start gap-2">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">可见操作</p>
                <p className="text-xs text-gray-600">可以看到浏览器窗口和操作过程</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-green-600 text-lg">🔧</span>
              <div>
                <p className="text-sm font-medium text-gray-900">便于调试</p>
                <p className="text-xs text-gray-600">适合调试和演示场景</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-green-600 text-lg">🔒</span>
              <div>
                <p className="text-sm font-medium text-gray-900">安全可控</p>
                <p className="text-xs text-gray-600">完全由您控制浏览器启动</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-green-600 text-lg">⚡</span>
              <div>
                <p className="text-sm font-medium text-gray-900">无需安装</p>
                <p className="text-xs text-gray-600">使用系统已安装的 Chrome</p>
              </div>
            </div>
          </div>
        </div>
