...
- [connector-config.ts:113-280](file://src/main/database/connector-config.ts#L113-L280)
...
alt 未配对
Conn->>Store : "savePairingRecord(code, userName, openId)"
alt 首个用户
