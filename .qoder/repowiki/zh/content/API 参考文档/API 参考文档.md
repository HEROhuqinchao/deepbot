...
## 简介
本文件为 DeepBot API 的全面参考文档，覆盖以下协议与能力：
...
## 结论
DeepBot 提供统一的网关层抽象，将 REST API、WebSocket 与 IPC 有机整合，既满足传统 HTTP 交互，又支持实时流式体验。通过严格的队列与错误恢复机制，保证高并发下的稳定性与一致性。
